<?php
	...
	switch ($view) {
		...
		case 'estadisticas_clientes':
			if($esCliente)
				$include = 'Modulos/Estadisticas/estadisticas_clientes.php';
			break;
	...
	case 'estadisticas_asistencia_gestor':
	    ...
	    case 'sueldos_basicos':
			if($permiso->getModuloLegajosBoolean() && (($esBO || $esContabilidad || $esRRHH) || $esCoordinador))
				$include = 'Modulos/Sueldos/basicos.php';
			break;	
        
        case 'sueldos_categorias':
			if($permiso->getModuloLegajosBoolean() && (($esBO || $esContabilidad || $esRRHH) || $esCoordinador))
				$include = 'Modulos/Sueldos/categorias.php';
			break;

		case 'sueldos_conceptos':
			if($permiso->getModuloLegajosBoolean()  && ($esGerencia || $esBO || $esContabilidad || $esRRHH ))
				$include = 'Modulos/Sueldos/conceptos_abm.php';
			break;
		...
		case 'licencias_control':
			if($permiso->getModuloLicenciasBoolean() && (($esBO || $esRRHH) || $esCoordinador || $esGerencia))
		...
		case 'asistencias_comparativas':
			if($permiso->getModuloLicenciasBoolean()  && ( $usuarioActivoSesion->getId()==3 || $usuarioActivoSesion->getId() ==10045 || $usuarioActivoSesion->getId() ==20174 || $usuarioActivoSesion->getId() ==10082 || $usuarioActivoSesion->getId() ==10007))
				$include = 'Modulos/Asistencia/comparativas.php';
			break;

	    case 'asistencias_comparativas_coordinador':
			if($permiso->getModuloLicenciasBoolean()  && ($esCoordinador && ($usuarioActivoSesion->getId() !=10045 || $usuarioActivoSesion->getId() ==20174 || $usuarioActivoSesion->getId() ==10082 ||  $usuarioActivoSesion->getId() !=10007)))
		...
		case 'asistencias_gerenciaBO':
			if($permiso->getModuloLicenciasBoolean()  && ($usuarioActivoSesion->getId()==10045 || $usuarioActivoSesion->getId()==3|| $usuarioActivoSesion->getId()==20168 ||$usuarioActivoSesion->getId()==10104 || $usuarioActivoSesion->getId() ==20174 || $usuarioActivoSesion->getId() ==10082 || $esBO || $usuarioActivoSesion->getId() ==10007))
		...
		case 'asistencias_historial':
			if($permiso->getModuloLicenciasBoolean()  && ($esCoordinador || $esBO || $usuarioActivoSesion->getId()==10045 || $usuarioActivoSesion->getId()==3|| $usuarioActivoSesion->getId()==20168 ||$usuarioActivoSesion->getId()==10104 || $usuarioActivoSesion->getId() ==10007))
