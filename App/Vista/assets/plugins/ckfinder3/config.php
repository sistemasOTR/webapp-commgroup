...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',    
    'baseUrl'      => (isset($_SESSION["usuario"]) || isset($_SESSION["logueado"])?BASE_URL.'Cliente/'.$_SESSION["usuario"].'_cliente/'.CARPETA_FILES_USUARIO:''),
    'root'         => (isset($_SESSION["usuario"]) || isset($_SESSION["logueado"])?PATH_ROOT.'Cliente/'.$_SESSION["usuario"].'_cliente/'.CARPETA_FILES_USUARIO:''),
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
