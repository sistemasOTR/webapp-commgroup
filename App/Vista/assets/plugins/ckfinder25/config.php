...
include_once "../../../../../../../Negocio/ConfigUsuario/configusuario.class.php";
...
function CheckAuthentication()
{
	...
	if(isset($_SESSION["usuario"]) || isset($_SESSION["logueado"]))    
        return true;
    else
        return false;
}
...
$config['LicenseName'] = 'www.inescapp.com';
$config['LicenseKey'] = 'ADNV59GWWF83QDGG9C4F7H349G9JTXWJ';
...
*/
$e = new ConfigUsuario;
$empresa = $e->selectEmpresaById($_SESSION["empresa"],$_SESSION["usuario"]);
$usuario_carpeta = $empresa->getUsuario()->getId();

$baseUrl = (isset($_SESSION["usuario"]) || isset($_SESSION["logueado"])?BASE_URL.'Cliente/'.$usuario_carpeta.'_cliente/'.CARPETA_FILES_USUARIO:'');
