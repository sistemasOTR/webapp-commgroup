<?php    
    ...
    $url_action_login= PATH_VISTA.'Login/action_login.php';
      ...
      <div class='col-md-4' style="height:90vh;">
        ...
        <div class="login-box" style="margin-top:190px;">
          ...
          <div class="login-box-body no-padding">        
            ...
            <form action=<?php echo $url_action_login; ?> method="post">
              ...
              <div class="row">
                <div class="col-xs-8">    
                  <a href=<?php echo $url_recuperar; ?> style='font-size: 15px;'>
                    ¿Te olvidaste tu contraseña?
                  </a>
                </div><!-- /.col -->
                <div class="col-xs-4">
                  <button type="submit" class="btn btn-primary btn-block btn-flat btn-lg">Iniciar</button>
                </div><!-- /.col -->
              </div>
            </form>  
          </div><!-- /.login-box-body -->
