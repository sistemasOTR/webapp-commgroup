             ...
             if (count($asistencias1)>1 || !empty($arrLicencias2)) {//
               ...
               $deLic=0;                
                     ...
                     if ($estados==99999) {   
                        ...
                        echo "<tr><td class='bg-green'> HRS PRODUCTIVAS : ".$totalcompP." Hs<span class='label label-default pull-right'>PROM ".$totalPROMprod."</span></td></tr>";
                        }
                        ...
                        echo "<tr><td class='bg-red'> HRS IMPRODUCTIVAS : ".$totalcompI." Hs<span class='label label-default pull-right'>PROM:".$totalPROMimp."</span></td></tr>";
                        }
