  ...
  <!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <p>El COMODANTE cede en comodato gratuito al COMODATARIO el siguiente bien mueble: Multifunción <span style="text-transform: uppercase;"><?php echo $impresora['_marca']; ?> <?php echo $impresora['_modelo']; ?></span> con Nº de serie <?php echo $fserialNro; ?> en perfecto estado de funcionamiento. Este comodato se inicia el día <?php echo $ffechaAsig; ?> y durará hasta el momento que se extinga la relación laboral.</p>
