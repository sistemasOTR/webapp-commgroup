                              ...
                              echo "<td class='text-center'>
                                      ...
                                      <button 
                                        ...
                                        onclick=btnAprobar(".$value->getId().")>
                                          <i class='fa fa-send' data-toggle='tooltip' data-original-title='Aprobar ticket'></i>
                                          Aprobar Ticket
                                      </button>   
...
<script type="text/javascript">
  ...
  function crearHref()
  {
      ...
      url_filtro_reporte="index.php?view=tickets_aprobar&fdesde="+f_inicio+"&fhasta="+f_fin  
