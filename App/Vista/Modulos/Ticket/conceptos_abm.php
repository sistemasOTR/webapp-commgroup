<?php
  ...
  $url_action_guardar_concepto = PATH_VISTA.'Modulos/Ticket/action_concepto.php';
  $url_action_editar_concepto = PATH_VISTA.'Modulos/Ticket/action_concepto.php';
...
<div class="content-wrapper">  
  <section class="content-header">
    <h1>
      ...
      <small>Agregar, modificar y eliminar los conceptos del Ticket</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
      <li class="active">Conceptos de Tickets</li>
    </ol>
  </section>        
...
<div class="modal fade in" id="modal-nuevo">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo $url_action_guardar_concepto; ?>" method="post">
...
<div class="modal fade in" id="modal-editar">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo $url_action_editar_concepto; ?>" method="post">
        <input type="hidden" name="id" id="id_concepto_edicion">
...
<script type="text/javascript">
  ...
  function cargarDatos(id){
    ...
    document.getElementById("id_concepto_edicion").value = id;
