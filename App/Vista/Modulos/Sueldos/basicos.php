<?php
  ...
  $url_action_guardar_basicos=PATH_VISTA.'Modulos/Sueldos/action_guardar_basico.php';
  $url_action_eliminar_basicos=PATH_VISTA.'Modulos/Sueldos/action_eliminar_basico.php';
