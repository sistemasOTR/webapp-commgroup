<?php
  ...
  $fcliente=(isset($_GET["fcliente"])?$_GET["fcliente"]:'-1');
  
  $handler_sistema = new HandlerSistema;
  $arrCliente = $handler_sistema->selectAllEmpresa();
...
<div class="content-wrapper">  
  <section class="content-header">
    <h1>
      ...
      <small>Control de los envios de guia a tiempo</small>
    </h1>
    <ol class="breadcrumb">
...
<script type="text/javascript"> 
  ...
  $(document).ready(function(){                
    $("#mnu_guias_control").addClass("active");
  });
  ...
  function crearHref()
  {
      ...
      url_filtro_reporte="index.php?view=guias_control&fdesde="+f_inicio+"&fhasta="+f_fin  
