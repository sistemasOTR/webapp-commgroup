                        ...
                        foreach ($consulta as $key => $value) {                         
                          echo "
                            <tr>
                              ...
                              if($value->getEstadosExpediciones()->getId()==1 || $value->getEstadosExpediciones()->getId()==2 || $value->getEstadosExpediciones()->getId()==3){
                                echo "<button 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form name="formCambiar" id="form" method="post" action=<?php echo $url_action_cambiar; ?>>    
          <input type="hidden" name="origen" value="CONTROL">        
                      ...
                      <?php
                        ...
                        {                     
                          ...
                          foreach ($arrEstados as $key => $value) {
                              ...
                              if($value->getId()==2 || $value->getId()==3)
                                echo "<option value='".$value->getId()."'>".$value->getNombre()."</option>";                                              
                          }
