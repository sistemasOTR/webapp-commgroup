<?php
	...
	$consulta = $handler->consultaCronologica($fdesde, $fhasta, $festado, $fcliente, $fgerente, $fcoordinador, $fgestor, $foperador, $fniveles);
?>
...
<div class='col-md-12'>
	<div class="box">
		<div class="box-header">
		  <h3 class="box-title">Cronologicas - <?php echo "desde <b>".$dFecha->FormatearFechas($fdesde,'Y-m-d','d/m/Y')."</b> hasta <b>".$dFecha->FormatearFechas($fhasta,'Y-m-d','d/m/Y')."</b>"; ?></h3>	  
		</div>
		...
		<div class="box-body table-responsive">
		  	<table class="table table-bordered table-condensed table-striped table-striped" id="tabla">
				...
				<tbody>
		  	  	...
		  	  	<tfoot>
			    	<tr>
			      		<th class='text-right' style='background: orange;' colspan="2">Totales</th>
...
<script type="text/javascript">
	...
	function crearHref()
	{
	    ...
	    url_filtro_reporte="index.php?view=estadisticas&consulta=cons5&fdesde="+f_inicio+"&fhasta="+f_fin
