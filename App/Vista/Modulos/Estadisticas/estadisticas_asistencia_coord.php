<?php
    ...
    $dFecha=new Fechas;
    $est_plaza=(isset($_GET['fplaza'])?$_GET['fplaza']:$user->getUserPlaza());
    $modalidad=(isset($_GET['user'])?$_GET['user']:'');
    ...
    <div class='container-fluid'> 
       ...
       <div class="row">     
          <div class='col-md-12'>
            ...
            <div class="box-header with-border">
             <div class='col-md-6'>
                <?php include_once"efectividad_asistencias_coord.php";?>
             </div>
             <div class='col-md-6'>
...
<script type="text/javascript">
  ...
  {   
      ...
      url_filtro_reporte="index.php?view=estadisticas_asis_coord&fplaza=<?php echo $est_plaza;?>&fdesde="+f_inicio+"&fhasta="+f_fin;
