                    ...
                    $consulta=$consulta[""];
                     ...
                     if(!empty($consulta)){
                      foreach ($consulta as $key => $value) {
                       ...
                       // $dif_dias_enviado = $dFecha->DiasDiferenciaFechas($TablaEnvios[""]->getFecha()->format('Y-m-d'),$tableEnviados[""]->getFecha()->format('Y-m-d'),"Y-m-d");

                     
                        $asda[]=$dif_dias_aprobado;
                        $seguir=true;
...
$arrPlazaDiasCant[]=array('PLAZA'=>$valor->getId());
...
<div class="col-md-4 nopadding">
    ...
    <div class="box-header">
      <h3 class="box-title" style="width: 100%;">
        <i class="ion-speedometer"> </i>Dias Aprobado Plazas <span><b><?php echo $valor->getNombre(); ?></b></span>
    ...
    <div class="box-body text-center">
	 <canvas id="budget_dias_aprobado<?php echo $valor->getId(); ?>" class="col-xs-12 chart"></canvas>
     </div>
	</div>
</div>
...
<script>
  ...
  var config_dias_aprobado<?php echo $valor->getId(); ?> = {
