<?php
    ...
    $arruser=$handlerUsuario->selectGestores($valor->getId()); // selectGestores
...
$dataAsistencia='';
if (!empty($act)) {
 foreach ($act as $k => $valores) {
  if ($valores!=0) {
$labl=$handlerAsistencia->selectEstadosById($k);
$labelsAsistencia=$labelsAsistencia."'".$labl[0]->getNombre()."', ";
$dataAsistencia=$dataAsistencia.$valores." , ";
...
// exit();
    ...
    if ($dataAsistencia!=0) { 
   $arrEstadosAsistencia[]=array('PLAZA'=>$valor->getId());
?>
...
<div class="col-md-12 nopadding">
    ...
    <div class="box-header">
      <h3 class="box-title" style="width: 100%;">
         </i> Horas Estados(<b>GESTORES</b>) <span><b><?php echo $valor->getNombre();?></b></span>
    ...
    <div class="box-body text-center">
	 <canvas id="budget_horas_estados_<?php echo $valor->getId(); ?>" class="col-xs-12 chart"></canvas>
     </div>
	</div>
</div>
...
<script>
    ...
    var config_horas_estados_<?php echo $valor->getId(); ?> = {
...
type: 'pie',
    data: {
      ...
      datasets: [{ 
        ...
        fill: false,
        borderColor: 'white',
        backgroundColor:['#A2D9CE','#E59866','#D7DBDD','#87CEFA'], 
