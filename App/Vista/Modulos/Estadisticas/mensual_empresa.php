<?php
   ...
   if (!empty($countServiciosMesCursoGestion[0]->CANTIDAD_SERVICIOS)) {
    ...
    // var_dump($countServiciosCerradosMesCursoGestion);
    ...
    for ($i=$fdesde; $i <= $fhasta; $i++) { 
    	...
    	$servCerrados = $handler->selectCountServiciosGestion($i,$i,200,$est_empresa,null,null,null,null);
    	$cerrados += $servCerrados[0]->CANTIDAD_SERVICIOS;
    	$servTotales = $handler->selectCountServiciosGestion($i,$i,null,$est_empresa,null,null,null,null);
