<?php
    ...
    //EFECTIVIDAD MENSUAL
    $countServiciosMesCurso = $handler->selectCountServicios($fMES,$fHOY,null,null,null,null,$est_plaza,null);  
    ...
    $countServiciosCerradosMesCurso = $handler->selectCountServicios($fMES,$fHOY,200,null,null,null,$est_plaza,null);
    ...
    $consulta = $handler->consultaPuntajesCoordinador($fMES,$fHOY,$est_plaza);
    ...
    if(!empty($consulta))
    {
      foreach ($consulta as $key => $value_puntaje) { 
        ...
        $objetivo = $handlerP->buscarObjetivoCoordinador($est_plaza);
