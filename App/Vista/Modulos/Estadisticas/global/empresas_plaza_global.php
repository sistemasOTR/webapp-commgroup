<?php
  ...
  // exit();
    ...
    for ($i=$fdesde; $i <= $fhasta; $i++) { 
      ...
      $servCerrados = $handler->selectCountServiciosGestion($i,$i,200,$value["EMPTT11_CODIGO"],null,null,null,null);
      $cerrados += $servCerrados[0]->CANTIDAD_SERVICIOS;
      $servTotales = $handler->selectCountServiciosGestion($i,$i,null,$value["EMPTT11_CODIGO"],null,null,null,null);
...
<script>
  var config_empresas_global<?php echo $value["EMPTT11_CODIGO"] ?> = {
    type: 'line',
    data: {
