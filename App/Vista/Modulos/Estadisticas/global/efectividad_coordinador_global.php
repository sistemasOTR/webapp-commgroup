<?php
    ...
    $arrGestores = $handler->selectServiciosByGestor($fHOY,$fHOY, 400, null, null, null,null, null);
...
<div class="col-md-12 nopadding">
    ...
    foreach ($dataGestores as $key => $val) {
	 ...
	 <canvas id="budget_cord_chart_global" class="col-xs-12 chart"></canvas>
     </div>
	</div>
</div>
...
type: 'bar',
    data: {
      ...
      datasets: [{ 
        ...
        backgroundColor:['#EAEDED','#2874A6','#85C1E9','#48C9B0','#BB8FCE','#FDEBD0','#B7950B','#979A9A','#A04000','#F1C40F','#D2B4DE'], 
        borderWidth: 0,
        lineTension: 0,
        pointRadius: 1,
      }]
