<?php
  ...
  $url_detalle_gestores = "index.php?view=puntajes_general_gestores&fcoordinador=";
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
            ...
            <?php 
              foreach ($arrCoordinador as $key => $plaza) {
                $total_servicios = 0;
                ...
                $objetivo=0;
                $consulta = $handler->consultaPuntajesCoordinador($fdesde, $fhasta, $plaza->SERTT91_COOALIAS);
            ...
            <div class="box box-solid">
              <div class="box-header with-border">
                <h3 class="box-title" style="text-transform: uppercase;"><?php echo $plaza->SERTT91_COOALIAS ?></h3>
                <a class="text-navy pull-right" href="<?php echo $url_detalle_gestores.$plaza->SERTT91_COOALIAS."&fdesde=".$fdesde."&fhasta=".$fhasta; ?>"><i class="fa fa-search"></i></a>
              </div>    
              <div class="box-body">
          ...
          <div class="col-xs-12">
            <a href="index.php?view=puntajes_general" class="btn btn-default"><i class="fa fa-chevron-left"></i> Volver</a>
          </div>
      </div>                
    </div>
