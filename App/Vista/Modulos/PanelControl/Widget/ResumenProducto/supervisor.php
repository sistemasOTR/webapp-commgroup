<?php
    ...
    //var_dump($valueEmpresas);
    //exit();

    $empresa = $valueEmpresas->EMPTT11_CODIGO;;

    if(!empty($empresa))
    {
      $arrEstados = $handler->selectGroupServiciosByEstados($fHOY,$fHOY,null,$empresa,null,null,null,null);   
    ...
    if(!empty($empresa))
    {
      ...
      $arrGestores = $handler->selectServiciosByGestor($fHOY,$fHOY, null, $empresa, null, null,null, null);
      $arrEstados = $handler->selectGroupServiciosByEstados($fHOY,$fHOY,null,$empresa,null,null,null,null); 

      $cerrados_efec =  $handler->selectCountServicios($fHOY,$fHOY, 6, $empresa, null, null, null, null);
      $despachados_efec = $handler->selectCountServicios($fHOY,$fHOY, 400, $empresa, null, null, null, null);  
    ...
    //INICIO SERVICIOS POR VENCER
      ...
      if(!empty($empresa))
      {
        $arrPorVencer = $handler->selectServiciosPorVencerByGestor(2,$empresa,null,null,null,null,'A TIEMPO');
    ...
    //INICIO SERVICIOS VENCIDOS
      if(!empty($empresa))
      {
        $arrVencido = $handler->selectServiciosPorVencerByGestor(2,$empresa,null,null,null,null,'VENCIDOS');  
...
?>
    ...
    <div class="box no-border">
      <div class="box-header with-border">
        <h3 class="box-title"><i class="ion-stats-bars"> </i> <?php echo $valueEmpresas->EMPTT21_NOMBREFA; ?></h3>
      </div>
      <div class="box-body no-padding">
        <div class="box-group" id="accordion">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="panel box no-border">
              <div class="box-header no-padding">
                <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $empresa; ?>-collapse1">
              ...
              <div id="<?php echo $empresa; ?>-collapse1" class="panel-collapse collapse">
                <div class="box-body no-padding">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="panel box no-border">
              <div class="box-header no-padding">
                <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $empresa; ?>-collapse2">
              ...
              <div id="<?php echo $empresa; ?>-collapse2" class="panel-collapse collapse">
                <div class="box-body no-padding">
                  <ul class="nav nav-stacked">
                    <?php             
          ...
          <div class="col-md-3 col-sm-6">
            <div class="panel box no-border">
              <div class="box-header no-padding">
                <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $empresa; ?>-collapse3">
              ...
              <div id="<?php echo $empresa; ?>-collapse3" class="panel-collapse collapse">
                <div class="box-body no-padding">
                  <ul class="nav nav-stacked">
                    <?php             
                      if(!empty($arrPorVencer)) {
          ...
          <div class="col-md-3 col-sm-6">
            <div class="panel box no-border">
              <div class="box-header no-padding">
                <a data-toggle="collapse" data-parent="#accordion" href="#<?php echo $empresa; ?>-collapse4">
              ...
              <div id="<?php echo $empresa; ?>-collapse4" class="panel-collapse collapse">
                <div class="box-body no-padding">
                  <ul class="nav nav-stacked">
                    <?php             
                      if(!empty($arrVencido)) {
