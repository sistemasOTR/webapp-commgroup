<?php
    ...
    /*-------------------------*/
   	...
   	$arrUltimosHistorico = $handler->selectUltimosServiciosHistorico($fHOY,$fHOY,$user->getUserSistema(),null,null,null,null);        
              ...
              foreach ($arrUltimosHistorico as $key => $value) {
                ...
                echo "
                  <tr>                          
                    ...
                    if(!empty(trim(strip_tags($value->HSETT91_NOMBRE))))
                      if(strlen(trim(strip_tags($value->HSETT91_NOMBRE)))>20)
                        echo "<td class='text-left'>".substr(trim(strip_tags($value->HSETT91_NOMBRE)),0,20)."... <i class='fa fa-search-plus pull-right' data-toggle='tooltip' title='' data-original-title='".trim(strip_tags($value->HSETT91_NOMBRE))."'></i></td>";
                      else
                    ...
                    if(!empty(trim(strip_tags($value->HSETT91_TELEFONO))))
                      if(strlen(trim(strip_tags($value->HSETT91_TELEFONO)))>20)
                        echo "<td class='text-left'>".substr(trim(strip_tags($value->HSETT91_TELEFONO)),0,20)."... <i class='fa fa-search-plus pull-right' data-toggle='tooltip' title='' data-original-title='".trim(strip_tags($value->HSETT91_TELEFONO))."'></i></td>";
                      else
                ...
                echo "              
                    ...
                    if(!empty(trim(strip_tags($observaciones))))
                      if(strlen(trim(strip_tags($observaciones)))>20)
                        echo "<td class='text-left'>".substr(trim(strip_tags($observaciones)),0,20)."... <i class='fa fa-search-plus pull-right' data-toggle='tooltip' title='' data-original-title='".trim(strip_tags($observaciones))."'></i></td>";
                      else 
