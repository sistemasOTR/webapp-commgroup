<?php
    ...
    /*-------------------------*/
   	...
   	$arrUltimosHistorico = $handler->selectUltimosServiciosHistorico($fHOY,$fHOY,null,$user->getUserSistema(),null,null,null);  
      ...
      <table class="table table-striped table-condensed" id="tabla" cellspacing="0" width="100%">
        ...
        <thead>
          <tr>                  
            ...
            <th class='text-left' style=''>Operador</th>  
              ...
              foreach ($arrUltimosHistorico as $key => $value) {
                ...
                //####################################################################
                    ...
                    if(!empty(trim(strip_tags($value->SERTT91_OPERAD))))
                      if(strlen(trim(strip_tags($value->SERTT91_OPERAD)))>10)
                        echo "<td class='text-left'>".substr(trim(strip_tags($value->SERTT91_OPERAD)),0,10)."... <i class='fa fa-search-plus pull-right' data-toggle='tooltip' title='' data-original-title='".trim(strip_tags($value->SERTT91_OPERAD))."'></i></td>";
                      else 
