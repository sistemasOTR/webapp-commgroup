<?php
  ...
  $countServiciosHoy = $handler->selectCountServicios($fHOY,$fHOY,null,null,null,null,null,null);    

  //ESTADO = 100 --> EN EL METODO ESTA PARA QUE FILTRE COMO GESTIONADO (MAYOR QUE DOS **2**)
  $countServiciosHoyGestionado = $handler->selectCountServicios($fHOY,$fHOY,100,null,null,null,null,null);              
