<?php
    ...
    $despachados_efec = $handler->selectCountServicios($fHOY,$fHOY, 100, null, $user->getUserSistema(), null, null, null);
    //$total_efec = $handler->selectCountServicios($fHOY,$fHOY, null, null, $user->getUserSistema(), null, null, null);    
