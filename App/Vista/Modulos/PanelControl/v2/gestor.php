    ...
    <div class="content-fluid">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
          <?php include_once PATH_VISTA."Modulos/PanelControl/Widget/Estados/gestor.php"; ?>
          <?php include_once PATH_VISTA."Modulos/PanelControl/Widget/Efectividad/gestor.php"; ?>
        </div>

        <div class="col-md-8 col-lg-9">              
          <?php include_once PATH_VISTA."Modulos/PanelControl/Widget/VencimientosGestiones/gestor.php"; ?>
        </div>
