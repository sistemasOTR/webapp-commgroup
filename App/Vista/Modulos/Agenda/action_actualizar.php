<?php
	...
	try {
		...
		$info = "../../../../index.php?view=agenda_detalle&fid=".$id."&info=";
			...
			$handler->actualizarEmpresa($id,$fecha_hora,$nombre,$rubro,$domicilio,$web,$per_contacto_1,$puesto_1,$telefono_1,$email_1,$per_contacto_2,$puesto_2,$telefono_2,$email_2);
