    ...
    <?php    
      if(!empty($arrDatos)){
        foreach ($arrDatos as $key => $value) {                    
          ...
          $url_hist = $url_detalle."&fechaing=".$value->SERTT11_FECSER->format('Y-m-d')."&nroing=".$value->SERTT12_NUMEING."&nrodoc=".$value->SERTT31_PERNUMDOC."&empresa=".$value->SERTT91_CODEMPRE.$filtros_listado;
          ...
          echo "<tr>";
              ...
              */
              ...
              echo "<td class='text-left'>".$value->SERTT91_HORARIO."</td>";
