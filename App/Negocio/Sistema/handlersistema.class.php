		...
		public function selectLastServicio($nrodoc){
			try {
				...
				$query = "SELECT TOP 1
						...
						FROM HISTSERVTT
						INNER JOIN EMPRESASTT ON
							HISTSERVTT.HSETT91_CODEMPRE = EMPRESASTT.EMPTT11_CODIGO 
						INNER JOIN GESTORESTT ON
							HISTSERVTT.HSETT91_CODGESTOR = GESTORESTT.GESTOR11_CODIGO 
						WHERE 
							".$filtro_nrodoc." AND 
							HSETT91_CODEMPRE = EMPTT11_CODIGO AND 
							HSETT91_CODGESTOR = GESTOR11_CODIGO 
						ORDER BY HSETT11_FECEST DESC";
